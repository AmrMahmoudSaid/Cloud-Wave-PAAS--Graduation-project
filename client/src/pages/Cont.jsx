...
function Cont() {
  return (
    <>
      <div className="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-white text-white">
        <a
        ...
        <a
          className="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-600"
          href="#"
        >
          <svg
            className="w-5 h-5"
        ...
        <a
          className="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 mt-auto rounded hover:bg-gray-600"
          href="#"
        >
          <svg
            className="w-5 h-5"
